					...
					<view class="item-title" v-for="(item,index) in documentaryData" :key="index">
						<view>
									...
									<view style="display: flex; flex-direction: column; margin-left: 5px;"
										...
										<view class="userInfo">
											...
											<!-- <view style="display: flex; align-items: center; font-size: 11px;"> -->
												<view
													style="height: 22px; line-height: 20px; padding: 0px 10px; background-color: #9A3B86; text-align: center; border-radius: 7px 0px 0px 7px; color: white;margin-left: 10px;">
													<!-- {{item.lianHongCount}}连红 -->
													1连红
													</view>
												<view
													style="color: #9A3B86; border: 1px solid red; border-radius: 0px 7px 7px 0px; height: 20px; line-height: 20px; text-align: center; padding: 0px 10px; ">
							...
							<view style="display: flex; align-items: center;"
								...
								<view
									style="width: 20%; text-align: center; background-image: linear-gradient(to top, #8D3D87 0%, #8D3D87 100%); padding: 7px 15px; margin: 0px 10px; color: white; border-radius: 10px;">
									<text>
										<span>跟单</span>
									</text>
								</view>
