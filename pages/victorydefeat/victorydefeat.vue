<template>
	<view class="box">
<!-- 		<cmd-nav-bar title="任选九" :back="true" font-color="#fff" background-color="#9A3B86" @rightText="rightText"
			right-text="任选九开奖">
		</cmd-nav-bar> -->
		<hx-navbar :config="{title: '任选九', backgroundColor: [1,'#8D3D87'], color: '#ffffff'}"/>
